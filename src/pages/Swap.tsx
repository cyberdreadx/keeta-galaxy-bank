                  ...
                  <AnimatePresence>
                    {showFromTokens && (
                      <motion.div
                        ...
                        animate={{ opacity: 1, y: 0 }}
                        exit={{ opacity: 0, y: -10 }}
                        className="fixed left-4 right-4 mt-1 z-[200] bg-[#0a1628] border border-sw-blue/40 rounded max-h-[300px] overflow-y-auto shadow-xl pb-40"
                        style={{ top: 'auto' }}
                      >
                  ...
                  <AnimatePresence>
                    {showToTokens && (
                      <motion.div
                        ...
                        animate={{ opacity: 1, y: 0 }}
                        exit={{ opacity: 0, y: 10 }}
                        className="fixed left-4 right-4 bottom-24 z-[200] bg-[#0a1628] border border-sw-blue/40 rounded max-h-[300px] overflow-y-auto shadow-xl pb-40"
                      >
